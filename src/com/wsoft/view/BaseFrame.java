...
public class BaseFrame extends JInternalFrame {
	...
	public BaseFrame() {
		...
		saveBtn.setIcon(new ImageIcon(BaseFrame.class.getResource("/icons/disk.png")));
		basicOperationsBar.add(saveBtn);

		this.deleteBtn = new JButton("Obri\u0161i");
		deleteBtn.setFont(new Font("Tahoma", Font.PLAIN, 14));
		deleteBtn.setIcon(new ImageIcon(BaseFrame.class
		...
		searchBtn.setIcon(new ImageIcon(BaseFrame.class
		...
		firstBtn.setIcon(new ImageIcon(BaseFrame.class
		...
		previousBtn.setIcon(new ImageIcon(BaseFrame.class
		...
		nextBtn.setIcon(new ImageIcon(BaseFrame.class
		...
		lastBtn.setIcon(new ImageIcon(BaseFrame.class
